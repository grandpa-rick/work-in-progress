...
\textbf{Source commit} & \texttt{\gitcommit} \\
 ...
 & this is the commit of the \LaTeX{} source of this document) \\
\bottomrule
\end{tabular}
\end{center}
...
\smallskip
\textbf{Grade of the main result: \texttt{computed}, not \texttt{proved}.} See \S\ref{sec:grade-caveat}
immediately below --- the derivation in \S\ref{sec:derivation} takes two Day-149 statements as
\emph{given} rather than proving them.}}
